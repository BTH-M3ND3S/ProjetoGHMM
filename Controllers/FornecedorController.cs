...
namespace SistemaGHMM.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FornecedorNome,FornecedorCnpj")] FornecedorModel fornecedorModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FornecedorNome,FornecedorCnpj")] FornecedorModel fornecedorModel)
        {
